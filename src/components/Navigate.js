        ...
        <nav className="uk-navbar-container uk-margin uk-navbar" uk-navbar data-uk-sticky>
            ...
            <div className="uk-navbar-right">
                <ul className="uk-navbar-nav uk-visible@s">
                    <li><a href="https://github.com/renbrent" target="_blank" rel="noopener noreferrer" className="uk-icon-hover" uk-icon="github"></a></li>  
                    <li><a href="https://www.linkedin.com/in/brentbasiano/" target="_blank" rel="noopener noreferrer" className="uk-icon-hover" uk-icon="linkedin"></a></li>
                    <li><a href="mailto:brentarnold.basiano@gmail.com" className="uk-icon-hover" uk-icon="mail"></a></li>                  
                </ul>
                <a href="#offcanvas" className="uk-navbar-toggle uk-hidden@s" uk-icon="menu" uk-toggle="target: #offcanvas"></a>
            </div>
